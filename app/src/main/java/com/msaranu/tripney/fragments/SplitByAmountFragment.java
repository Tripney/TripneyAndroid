...
import com.msaranu.tripney.databinding.FragmentSplitByAmountBinding;
 ...
 * Use the {@link SplitByAmountFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SplitByAmountFragment extends android.support.v4.app.Fragment  {
    ...
    FragmentSplitByAmountBinding fragmentBinding;
    SplitRecyclerAdapter adapter;
    Double amount;

    public SplitByAmountFragment() {
        // Required empty public constructor
    }


    public static SplitByAmountFragment newInstance(String eventID, Double amount, ArrayList<Split> splits) {
        SplitByAmountFragment splitByAmountFragment = new SplitByAmountFragment();
        Bundle args = new Bundle();
        args.putString(EVENT_ID, eventID);
        args.putDouble(AMOUNT, amount);
        args.putParcelableArrayList("SPLIT_OBJ", splits);
        splitByAmountFragment.setArguments(args);
        return splitByAmountFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        fragmentBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_split_by_amount, parent, false);
    ...
    private void setRecyclerView(View view) {
        ...
        adapter = new SplitRecyclerAdapter(this.getContext(), splits, amount, "AMOUNT");
